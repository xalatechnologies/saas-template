                ...
                <GridLayout columns={{ mobile: 1, tablet: 2 }} gap="lg">
                  {features.map((feature, index) => {
                    ...
                    return (
                      <div
                        key={index}
                        className="bg-white/10 backdrop-blur-xl rounded-xl p-8 border border-white/20 hover:bg-white/20 transition-all duration-300 hover:shadow-2xl hover:-translate-y-1"
                      >
              ...
              {(type === 'login' || type === 'signup') && (
                <>
                  ...
                  <GridLayout columns={{ mobile: 2 }} gap="md">
                    <Button
                      variant="outline"
                      className="rounded-xl h-16 font-medium"
                      type="button"
                    >
